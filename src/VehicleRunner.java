public class VehicleRunner
{
    public static void main(String[] args)
    {
        ...
        Bicycle myBike = new Bicycle("Huffy 22", 2, 12);
        ...
        GolfCart myGolfCart = new GolfCart("Bat-Caddy 2", 4, 2);
        System.out.println(myGolfCart.getName());
        System.out.println(myGolfCart.getWheels());
        System.out.println(myGolfCart.getNumPassengers());
        myGolfCart.move(10);
        myGolfCart.turn(90);
        myGolfCart.brake(0.7);
        myGolfCart.honk();
